    ...
    async listUserDetails (ctx) {
        try {
            ...
            const formattedUser = {
                ...
                admissionDate: user.client.professional_data?.admissionDate ? new Date(user.client.professional_data.admissionDate).toISOString() : null,
                natureOfThePosition: user.client.professional_data?.natureOfThePosition,
                ...
                dismissalDate: user.client.professional_data?.dismissalDate ? new Date(user.client.professional_data.dismissalDate).toISOString() : null,
                dismissalObservation: user.client.professional_data?.dismissalObservation,
            ...
            console.log(err)
            throw new ApplicationError(
                err instanceof ApplicationError ? err.message : 'Erro ao listar detalhes do colaborador, tente novamente'
            )
        }
    }
}
